  ...
  static createFanDevice(miioDevice, model, deviceId, name, log, fanController) {
    ...
    if (miioDevice || model) {
      ...
      if (SMARTMI_MIIO_DEVICES.includes(fanModel)) {
        ...
        fanDevice = new MiioSmartmiFan(miioDevice, model, deviceId, name, log);
      } else if (DMAKER_MIIO_DEVICES.includes(fanModel)) {
        // do dmaker miio stuff
        fanController.logDebug(`Creating DmakerFan device!`);
        fanDevice = new MiioDmakerFanP5(miioDevice, model, deviceId, name, log);
        ...
        fanDevice = new MiotDmakerAcFan(miioDevice, model, deviceId, name, log);
        ...
        fanDevice = new MiotDmakerDcFan(miioDevice, model, deviceId, name, log);
        ...
        fanDevice = new MiotSmartmiDcFan(miioDevice, model, deviceId, name, log);
      } else {
        ...
        fanDevice = new MiotGenericFan(miioDevice, model, deviceId, name, log);
      }
    }
