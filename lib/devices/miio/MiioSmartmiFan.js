...
class MiioSmartmiFan extends MiioFan {
  ...
  initFanCapabilities() {
    ...
    this.addCapability(Constants.FAN_CAP_OSCILLATION_ANGLE_RANGE, [0, 120]);
    ...
    this.addCapability(Constants.FAN_CAP_BUZZER_CONTROL_LEVELS, true);
    this.addCapability(Constants.FAN_CAP_LED_CONTROL, true);
    this.addCapability(Constants.FAN_CAP_LED_CONTROL_LEVELS, true);
    this.addCapability(Constants.FAN_CAP_USE_TIME_REPORTING, true);
