...
class MiotDmakerDcFan extends MiotFan {
  ...
  initFanCapabilities() {
    ...
    if (this.model === 'dmaker.fan.p11' || this.model === 'dmaker.fan.p15') {
      // for some reason those fans do not have the fan spee din their miot spec, even that they are DC fans and the mi home app supports step less fan control, why?
      this.addCapability(FanCapabilities.FAN_SPEED_CONTROL, false);
    }
  }
  ...
  addFanProperties() {
    ...
    } else if (fanModel === 'dmaker.fan.p10') {
      // dmaker.fan.p10
      this.defineProperty('child_lock', 3, 1);
  ...
  //    this.defineProperty('fan_speed', 2, 10); // missing in the spec, how does the mi home app does it?
      this.defineProperty('swing_mode', 2, 4);
      this.defineProperty('swing_mode_angle', 2, 5);
