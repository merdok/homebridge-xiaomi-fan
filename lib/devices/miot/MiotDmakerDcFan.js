...
class MiotDmakerDcFan extends MiotFan {
  ...
  initFanCapabilities() {
    ...
    this.addCapability(Constants.FAN_CAP_OSCILLATION_LEVEL_CONTROL, true);
    this.addCapability(Constants.FAN_CAP_OSCILLATION_LEVELS, [30, 60, 60, 120, 140]);
    ...
    this.addCapability(Constants.FAN_CAP_POWER_OFF_TIMER_UNIT, 'minutes');
