...
class MiotSmartmiDcFan extends MiotFan {
  ...
  initFanCapabilities() {
    ...
    this.addCapability(Constants.FAN_CAP_FAN_SPEED_CONTROL, true);
    this.addCapability(Constants.FAN_CAP_FAN_SPEED_RPM, true);
    this.addCapability(Constants.FAN_CAP_FAN_LEVEL_CONTROL, true);
    this.addCapability(Constants.FAN_CAP_NUMBER_OF_FAN_LEVELS, 4);
    this.addCapability(Constants.FAN_CAP_OSCILLATION_CONTROL, true);
    this.addCapability(Constants.FAN_CAP_OSCILLATION_ANGLE_CONTROL, true);
    this.addCapability(Constants.FAN_CAP_OSCILLATION_ANGLE_RANGE, [30, 120]);
    this.addCapability(Constants.FAN_CAP_LEFT_RIGHT_MOVE, true);
    this.addCapability(Constants.FAN_CAP_NATURAL_MODE, true);
    this.addCapability(Constants.FAN_CAP_CHILD_LOCK, true);
    this.addCapability(Constants.FAN_CAP_POWER_OFF_TIMER, true);
    this.addCapability(Constants.FAN_CAP_POWER_OFF_TIMER_UNIT, 'seconds');
    this.addCapability(Constants.FAN_CAP_BUZZER_CONTROL, true);
    this.addCapability(Constants.FAN_CAP_LED_CONTROL, true);
    this.addCapability(Constants.FAN_CAP_LED_CONTROL_LEVELS, true);
    this.addCapability(Constants.FAN_CAP_IONISER_CONTROL, true);
    this.addCapability(Constants.FAN_CAP_TEMPERATURE_REPORTING, true);
    this.addCapability(Constants.FAN_CAP_HUMIDITY_REPORTING, true);
    this.addCapability(Constants.FAN_CAP_BUILT_IN_BATTERY, true);
    this.addCapability(Constants.FAN_CAP_BATTERY_STATE_REPORTING, true);
  }
  ...
  getSpeed() {
    return this.getFanProperties().fan_speed_rpm;
  }
  ...
  getBatteryLevel() {
    return this.getFanProperties().battery;
  }
